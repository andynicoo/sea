import { invoiceTaxRateApi } from '../../api/shoppingCar/shoppingCar';
...
export default {
  ...
  computed: {
    taxes() {
      ...
      let discount = util.countSum([this.orderPaidMoney, -this.discAmountMoney]);
      let num = util.formatDecimal(util.floatMultiply(taxRate, discount < 0 ? 0 : discount), 2) || '0';
