<template>
    <div class="container" id="page" ref='page'>
      ...
      <div class="top-box">
          <img class="top-bg" src="./images/hold-bg.png" alt="">
      ...
      <div class="bottom-bg">
        ...
        <div class="coupon-box clearfix" v-if="false">
      ...
      <div  class="float-eft">
        <div class="float-box">
            ...
            <div class="float-item"><img src="@/assets/images/activity618/phone.png" alt="" >手机端
              <div class="img-hide-out">
                <div class="img-hide">
                  <img src="@/assets/images/activity/code-thur.png" alt="">
                  <p>手机扫码 参与活动</p>
                </div>
              </div>
            </div>
  ...
  data () {
    return {
      ...
      rules: [
        ...
        '如有恶意刷订单获取秒杀商品等违反活动公平性的违规行为，跨标云将取消违规订单，且金额概不退还',
        '最终解释权归跨标云（深圳）科技有限公司所有'
      ],
    ...
    .float-box{
      ...
      .float-item{
        ...
        .img-hide {
          ...
          box-shadow: -1px -1px 2px 0px rgba(217,132,66,0.4600), 1px 1px 2px 0px rgba(217,132,66,0.5300);
          border-radius: 10px;
          position: relative;
          img {
            display: block;
          ...
          &:after {
            ...
            border-top: 0;
            border-right: 0;
            box-shadow: -1px -1px 2px 0px rgba(217,132,66,0.4600), 1px 1px 2px 0px rgba(217,132,66,0.5300), 0, 0;
