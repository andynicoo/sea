<template>
  <div class="container">
    <div class="content">
      ...
      <Form ref="formLeft">
        <Row>
          <Col :span="8" v-if="countryCode !== 'AE' && countryCode !== 'SA'">
            <!-- 法国注册申报授权书 -->
            <FormItem
            ...
            >
              ...
              >
                <div class="inner img-box">
                  <a :href="showLeft.regAuthorizationFile" target="_blank" class="show-pdf">
                    {{ $route.query.supplierId == 61 ? "代表授权书ECO TAX" : "授权书" }}
                  </a>
              ...
              <div class="upload-tip" v-if="countryCode == 'NL'">
                <a href="https://file.itaxs.com/dev/20210226/9bfb9861c9b54662922680174334f798.jpg" target="_blank">
                  <img src="@/assets/images/common/searchImg.png" alt="" />
                  查看示例
                </a>
              </div>
              <!-- 意大利-MT服务商 查看示例 -->
               <div class="upload-tip" v-if="countryCode == 'IT' && $route.query.supplierId == 86">
                <a href="http://file.itaxs.com/pro/20210901/e8a508aac06342c89d6dd62f560cd5ed.png" target="_blank">
                  <img src="@/assets/images/common/searchImg.png" alt="" />
                  查看示例
                </a>
              </div>
              ...
              <!-- AWA授权书查看示例 -->
                ...
                <a v-else-if="$route.query.supplierId == 97">  本授权书无需签字盖章，核对无误后重新上传即可 </a>
              ...
              <div class="upload-tip" v-if="countryCode == 'NL'" style="margin-left: 10px">
                <a href="javascript:;" style="color: #ed3e3e" @click="uploadAuthorizationTep">
              ...
              <div class="upload-tip" v-if="countryCode == 'FR'" style="margin-left: 10px">
                <a
                  href="javascript:;"
                  v-if="$route.query.supplierId == 61"
          ...
          <Col :span="8" v-if="countryCode == 'FR' && ($route.query.supplierId == 96 || $route.query.supplierId == 97)">
            ...
            >
              ...
              <div class="upload-tip" v-if="countryCode == 'FR'" style="margin-left: 10px">
                ...
                <a
                  href="javascript:;"
                  v-else-if="$route.query.supplierId == 96 || $route.query.supplierId == 97"
          ...
          <Col :span="8" v-if="countryCode !== 'AE' && countryCode !== 'SA'">
            <FormItem
              label="欧洲公司授权税务代理书"
              v-if="countryCode == 'FR' && $route.query.supplierId == 61"
              style="margin-bottom: 15px"
              class="flex-direction requiredItem"
            >
              <Upload
          ...
          <Col :span="8" v-if="countryCode == 'NL'">
            <FormItem
              label="申请函"
              v-if="countryCode == 'NL'"
              style="margin-bottom: 15px"
            ...
            >
              ...
              <div class="out-img-box" v-if="formLeft.taxRegisterLetter !== '' && showLeft.taxRegisterLetter != ''">
                <div class="inner img-box">
                  <a :href="showLeft.taxRegisterLetter" target="_blank" class="show-pdf"> 申请函 </a>
                  <Button class="deletBtn">
                    <img
              ...
              <div class="upload-tip" v-if="countryCode == 'NL'">
                <a href="https://file.itaxs.com/dev/20210226/d7328f8ec31844eaab640f47a7a8ddcf.jpg" target="_blank">
                  <img src="@/assets/images/common/searchImg.png" alt="" />
                  查看示例
                </a>
              </div>
              <div class="upload-tip" v-if="countryCode == 'NL'" style="margin-left: 10px; color: #ed3e3e">
                <a href="javascript:;" @click="uploadShenQingHan" style="color: #ed3e3e">
                  <img src="@/assets/images/common/downloadImg.svg" alt="" />
                  下载申请函
                </a>
              </div>
          ...
          <Col :span="8" v-if="countryCode == 'AE' || countryCode == 'SA'">
            ...
            >
              ...
              <div class="upload-tip" v-if="countryCode == 'AE' || countryCode == 'SA'" style="margin-left: 10px">
                <a href="javascript:;" style="color: #ed3e3e" @click="downLoad">
                  <img src="@/assets/images/common/downloadImg.svg" alt="" />
                  下载flowchat
                </a>
              </div>
          ...
          <!-- 西班牙授权 -->
          <Col :span="8" v-if="countryCode == 'ES'">
            <FormItem
              label="海牙中西语授权书："
              v-if="countryCode == 'ES'"
              style="margin-bottom: 15px"
  ...
  methods: {
    ...
    sureEnterHaugeInfo() {
      if (this.countryCode == "AE" || this.countryCode == "SA") {
        ...
        if (this.$route.query.supplierId == 61) {
          if (this.formLeft.regAuthorizationFile == "") {
            this.$Message.info("请先上传代表授权书ECO TAX");
            return;
          }
          if (this.formLeft.regAuthorizationFile1 == "") {
            this.$Message.info("请先上传欧洲公司授权税务代理书");
            return;
          }
        } else if (this.$route.query.supplierId == 96 || this.$route.query.supplierId == 97) {
          if (this.formLeft.regAuthorizationFile == "") {
    ...
    uploadShenQingHan() {
      let self = this;
      this.spinShow = true;
      this.operateText = "正在下载申请函，请稍后";
      let formData = new FormData();
      formData.append("servicesId", this.serviceId);
      formData.append("operationType", "3");
      // 获取时间戳
      let timestamp = new Date().getTime();
      // 获取XMLHttpRequest
      let xmlResquest = new XMLHttpRequest();
    ...
    downLoad() {
      let self = this;
      this.spinShow = true;
      this.operateText = "正在下载flowchat，请稍后";
      let formData = new FormData();
      formData.append("servicesId", this.serviceId);
