  ...
  <div class="container">
    <header>
      <div class="headerContent">
        <img src="@/assets/images/login/logo7.png" alt="" />
        <span>Leading taxation to compliance, standardization, intelligentization</span>
      </div>
    </header>
    <div class="content">
          ...
          <Form ref="loginForm" :model="loginForm" :rules="loginRule" inline>
            ...
            <Radio v-model="agreementRadio" v-if="loginType === 4 || loginType === 3">
              <span style="font-size: 12px">
                Agree terms
                <a style="color: #169fe9" href="https://pro.itaxs.com/agreement.html" target="_blank">
            ...
            <p class="flex-between" v-else>
              ...
              <span style="color: #999999; cursor: pointer" @click="changeType(4, 'loginForm')">Forget password</span>
            </p>
          </Form>
        </div>
      </div>
      <p class="bottomBox">
        <a href="https://www.itaxs.com/agreement.html" target="_blank">User Agreement</a>
...
export default {
  data() {
    return {
      ...
      agreementRadio: "",
      loginRule: {
        user: [{ required: true, message: "Enter account name", trigger: "blur", type: "string" }],
        mobile: [{ required: true, message: "Enter Phone number", trigger: "blur", type: "string" }],
        password: [{ required: true, message: "Enter password", trigger: "blur", type: "string" }],
        imgCode: [{ required: true, message: "Enter the graphic verification code", trigger: "blur", type: "string" }],
        code: [{ required: true, message: "Enter a verification code", trigger: "blur", type: "string" }],
        agreement: [
          { required: true, message: "Please agree to the terms of service", trigger: "blur", type: "string" },
        ],
      },
      isQRLogin: false,
      wxQRcode: "",
      ...
      getPass(obj)
        .then(
          (res) => {
            // console.log(res);
            if (res.code == 0) {
              this.$Message.success("The new password has been set successfully, please");
              this.changeType(1, "loginForm");
            } else {
              this.$Message.error(res.message);
            }
