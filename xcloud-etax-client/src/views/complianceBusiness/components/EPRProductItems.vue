    ...
    return {
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            if (this.isDetails) {
              return h('span', params.row.priceCodeEcologic);
            }
            return h('Input', {
              props: {
                value: params.row.priceCodeEcologic,
                // size: 'small',
                maxlength: 500,
                disabled: this.disabled,
              },
              on: {
                input: (val) => {
                  this.productList[params.index].priceCodeEcologic = val;
                },
              },
            });
          },
        ...
        },
        {
          ...
          render: (h, params) => {
            if (this.isDetails) {
              return h('span', params.row.unitEcoFee);
            }
            return h('Input', {
              props: {
                value: params.row.unitEcoFee,
                // size: 'small',
                maxlength: 500,
                disabled: this.disabled,
              },
              on: {
                input: (val) => {
                  this.productList[params.index].unitEcoFee = val;
                },
              },
            });
          },
        ...
        },
        {
          ...
          render: (h, params) => {
            ...
            return h('Input', {
              ...
              on: {
                input: (val) => {
                  this.productList[params.index].totalFee = val;
                },
              },
            });
          },
