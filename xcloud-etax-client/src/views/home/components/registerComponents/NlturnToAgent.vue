            ...
            <div class="stepH">
              <div>
                <FormItem class="requiredItem"
                  ...
                  <!-- <p style="color:#F59A23;font-size:12px;">注：银行的地址（请使用英文输入）</p> -->
                </FormItem>
                <FormItem class="requiredItem"
                          prop="declarePeriod">
              ...
              <div class="form-item">
                <div>
                  ...
                  <!-- <p style="color:#F59A23;font-size:12px;margin-left:126px;">注：建议与注册店铺时信息一致</p> -->
                </div>
              </div>
            </div>
          </div>
              ...
              <div style="width:294px">
                ...
                <FormItem class="requiredItem"
                  ...
                  <span class="explame" v-if="!ischange">
                    <a href="https://ksyvat.oss-cn-shenzhen.aliyuncs.com/dev/20210121/e79a68720fc649429710414dc5bbc8fa.jpg"
        ...
        <div class="big-row">
          ...
          <div class="form">
            <FormItem prop="companyLegalPersonSign"
                      class="legalPersonSignatureBox requiredItem">
              <div class="legalPersonSignature ">
                <div class="signContent">
                  ...
                  <div class="" style="color:#FBB73C;margin-top:30px">
                    说明：法人签名主要应用于转代理申报授权,请使用英文格式签名，如张三（San Zhang）
                    <p>
...
import { getCompanyInformation, getAllServiceCompanies, getCompanyLegalPersonSignUrl, getCompanyLegalPersonSign } from "@/api/registerInfo/registerInfo";
