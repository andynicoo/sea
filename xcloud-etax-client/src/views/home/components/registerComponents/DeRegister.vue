    ...
    <div class="content">
      <Form :model="formLeft"
        ...
        <div class="item-content">
          ...
          <!-- 海外公司的上传文件 -->
          <!-- todo 新增 -->
          <Row v-if="formLeft.shopNature === '1'&&formLeft.companyType==='3'">
            <Col :span="8">
              <FormItem label="营业执照扫描件"
            ...
            <Col :span="8">
              <FormItem label="营业执照英文翻译件"
                ...
                <Upload :before-upload="beforeUploadHandler"
                        ...
                        :disabled="notChange">
                  <div class="inner"
                      @click="beforType('companyBusinessLicenseTranslate')">
                    <img class="uplad-symbol"
                        src="@/assets/images/common/uploadIcon1.png"
                        alt="">
                    <span class="uplad-word">点击上传</span>
                ...
                <div class="out-img-box"
                    v-if="formLeft.companyBusinessLicenseTranslate !==''">
                  <div class="inner img-box">
                    <a :href="formLeft.companyBusinessLicenseTranslate"
                      target="_blank"
                      class="show-pdf">
                      营业执照英文翻译件
                    </a>
                    <Button class="deletBtn">
                      <img @click="removeHandler(1,1,'companyBusinessLicenseTranslate')"
                          class="closeImg"
                          v-if="!notChange"
                          src="@/assets/images/common/activeCloseImg.png"
                          alt="">
          ...
          <Row>
            ...
            <!-- todo 新增 -->
            <Col :span="8">
            <FormItem label="公司所在国家/地区"
                      v-if="formLeft.shopNature === '1'"
                      class="requiredItem"
                      style="width:300px;"
                      prop="coRegionCode">
              <Select v-model="formLeft.coRegionCode"
                     placeholder="请选择公司所在国家/地区"
                     :disabled="notChange">
            ...
            <!-- naoki add -->
            <Col :span="8"> 
            <FormItem label="请输入公司所在国家英文名称"
                      v-if="formLeft.coRegionCode != 'CN-OTHER'"
                      class="requiredItem"
                      style="width:300px;"
                      prop="companyAddressEnCountry">
              <Input v-model="formLeft.companyAddressEnCountry"
                     placeholder="请输入公司所在国家英文名称 如 China"
                     :disabled="notChange"></Input>
            </FormItem>
            </Col>
          </Row>
        ...
        <div class="item-content">
          ...
          <Row>
            ...
            <Col :span="8">
            <FormItem label="法人出生地邮编"
                      class="requiredItem"
                      style="width:300px;"
                      prop="legalPersonPostCode">
              <Input v-model="formLeft.legalPersonPostCode"
                     placeholder="请输入法人出生地邮编"
                     :disabled="notChange"></Input>
            </FormItem>
            </Col>
          ...
          <Row>
            ...
            <p style="font-size: 14px;font-weight: 400;color: #FBB73C;line-height: 18px;margin-top: 10px;">注：请用拼音输入身份证地址；</p>
            </Col>
            <Col :span="8">
            <div class="legalPersonSignature">
              ...
              <p style="font-size: 14px;font-weight: 400;color: #FBB73C;line-height: 18px;margin-top:10px;">
                说明：法人签名需“名在前姓在后，首字母大写”（如张三，San Zhang）<br/>
        ...
        <div class="item-content">
          ...
          <Row>
              ...
              <Tooltip placement="right"
                ...
                <span class="tips-icon">
                  <img src="@/assets/images/common/wenhao.png"
                       alt=""></span>
                <div slot="content">
                  <p>新账户：填写最近一个月左右的时间为税号生效日，建议填写月初不填月尾，因为计税是完整月计算的；</p>
            ...
            <Col :span="8">
            <FormItem label="今年预计销售额"
                      class="requiredItem"
                      style="width:300px;"
                      prop="shopPredictSale">
              <Input v-model="formLeft.shopPredictSale"
                     placeholder=" 请输入销售额（欧元）"
                     type="number"
                     :disabled="notChange">
              <span slot="append">EUR</span>
              </Input>
              <!-- eslint-disable -->
              <p style="font-size: 14px;font-weight: 400;color: #FBB73C;line-height: 18px;margin-top: 10px;">注： 预计销售额需>=50000，<=200000； </p>
            </FormItem>
            </Col>
          </Row>
          <Row>
            ...
            <Col :span="8">
            <FormItem label="明年预计销售额"
                      class="requiredItem"
                      style="width:300px;"
                      prop="shopNextYearSale">
              <Input v-model="formLeft.shopNextYearSale"
                     placeholder="请输入销售额（欧元）"
                     type="number"
                     :disabled="notChange">
              <span slot="append">EUR</span>
            ...
            <FormItem label="是否有欧盟EORI号"
              ...
              <RadioGroup v-model="formLeft.isThereEoriNumber">
                <Radio label="1"
                       :disabled="notChange">有EORI号</Radio>
                <Radio label="2"
                       :disabled="notChange">无EORI号</Radio>
              </RadioGroup>
            </FormItem>
            </Col>
          </Row>
          <Row>
            ...
            <FormItem label="德国仓库地址"
                      class="requiredItem"
                      style="width:300px;"
                      prop="shopEntrepotAddress">
              <Input v-model="formLeft.shopEntrepotAddress"
                     placeholder="与仓库地址中FBA德国仓库地址保持一致"
                     :disabled="notChange">
              </Input>
            </FormItem>
            </Col>
            ...
            <FormItem label="物流承运商公司名称"
                      class="requiredItem"
                      style="width:300px;"
                      prop="shopLogisticsCompanyName">
              <Input v-model="formLeft.shopLogisticsCompanyName"
                     placeholder="与销售平台保持一致，如：Amazon"
                     :disabled="notChange">
              </Input>
            </FormItem>
            </Col>
          ...
          <Row>
            ...
            <FormItem label="物流承运商地址"
                      class="requiredItem"
                      style="width:300px;"
                      prop="shopLogisticsCompany">
              <Input v-model="formLeft.shopLogisticsCompany"
                     placeholder="与德国仓库地址保持一致"
                     :disabled="notChange">
              </Input>
            </FormItem>
            </Col>
            ...
            <FormItem label="卖家记号"
                      style="width:300px;">
              <Input v-model="formLeft.sellMark"
                     :maxlength="50"
                     placeholder="请填写卖家记号"
                     :disabled="notChange">
              </Input>
              <p style="font-size: 14px;font-weight: 400;color: #FBB73C;line-height: 18px;margin-top: 10px;">例如：A1***795***FR9</p>
            </FormItem>
            </Col>
          </Row>
          <Row>
            ...
            <FormItem label="店铺后台公司信息页面截图"
              ...
              <p style="font-size: 14px;font-weight: 400;color: #FBB73C;">注：支持JPG、JPEG、PNG、PDF格式上传</p>
              <div class="upload-tip">
                <a href="https://fdfs.itaxs.com/group1/M00/00/27/rBLKNV61CJKACMtaAAtFQeS7riM549.pdf"
                   target="_blank">
                  <img src="@/assets/images/common/searchImg.png"
                       alt="">
                  查看示例
            ...
            <Col :span="8">
            <FormItem label="仓储地址截图"
                      style="margin-bottom:15px;width:300px;"
                      class="flex-direction requiredItem"
                      prop="storageAddressImg">
              <Upload :before-upload="beforeUploadHandler"
                      :on-format-error="formatErrorHandler"
                      ...
                      :disabled="notChange">
                <div class="inner"
                     @click="beforType('storageAddressImg')">
                  <img class="uplad-symbol"
                       src="@/assets/images/common/uploadIcon1.png"
                       alt="">
                  <span class="uplad-word">点击上传</span>
              ...
              <div class="out-img-box"
                   v-if="formLeft.storageAddressImg !==''">
                <div class="inner img-box">
                  <a :href="formLeft.storageAddressImg"
                     target="_blank"
                     class="show-pdf">
                    仓储地址截图
                  </a>
                  <Button class="deletBtn">
                    <img @click="removeHandler(1,1,'storageAddressImg')"
                         class="closeImg"
                         v-if="!notChange"
                         src="@/assets/images/common/activeCloseImg.png"
                         alt="">
              ...
              <p style="font-size: 14px;font-weight: 400;color: #FBB73C;">注：支持JPG、JPEG、PNG、PDF格式上传</p>
              <div class="upload-tip">
                <a href="https://fdfs.itaxs.com/group1/M00/02/3D/rBLKNV8xCbeAGoDXABPw3e8DDKw534.pdf"
                   target="_blank"
                   style="margin-right: 132px;">
                  操作指引>>
                </a>
                <a href="https://file.itaxs.com/dev/20210319/33183fcd21db49e297e6f60b7a396b65.png"
                   target="_blank">
                  <img src="@/assets/images/common/searchImg.png"
                       alt="">
                  查看示例
...
import { identifyBusinessLicense, identifyIdCard } from "@/api/taxModule";
export default {
  ...
  data() {
    ...
    return {
      ...
      ruleForm: {
        sellMark: [
          { required: true, trigger: "change", message: "请输入卖家记号", }
        ],
        shopNature: [
        ...
        shopOtherEuTaxNumber: [
          {
            required: true,
            trigger: "change",
            message: "请选择是否有其他欧盟税号",
          },
        ],
        shopEntrepotAddress: [
          { required: true, trigger: "change", message: "请输入德国仓库地址" },
        ],
        shopLogisticsCompanyName: [
          {
            required: true,
        ...
        taxRegisterLetter: [
          { required: true, trigger: "change", message: "请上传税务申请函" },
        ],
        isOtherGulfStateDutyOrServices: [
          {
            required: true,
            trigger: "change",
            message: "请选择是否有其他海湾国税号或业务",
          },
        ],
        isThereShop: [
  ...
  methods: {
            ...
            if (JSON.stringify(res.data) !== "{}") {
              for (const key in res.data) {
                if (
                  ...
                  that.formLeft.hasOwnProperty(key)
                ) {
    ...
    saveData() {
      if (
        this.formLeft.shopPredictSale < 0 ||
        this.formLeft.shopNextYearSale < 0
      ) {
    ...
    translateDate(data) {
      data.shopTaxEffectiveData = this.formatDate(
        this.formLeft.shopTaxEffectiveData,
        "date"
      );
      data.companyRegisterData = this.formatDate(
        this.formLeft.companyRegisterData,
        "date"
      );
      data.companyLegalPersonBirthday = this.formatDate(
        this.formLeft.companyLegalPersonBirthday,
        "date"
      );
    },
    // 公司资料信息自动填充
