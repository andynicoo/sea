      ...
      <Form :model="formLeft"
        ...
        <div class="item-content">
          ...
          <Row>
            ...
            <FormItem label="营业执照扫描件"
                      v-if="formLeft.shopNature === '1'&&(formLeft.companyType==='1' || formLeft.companyType==='3')"
        ...
        <div class="item-content">
          ...
          <Row>
            ...
            <Col :span="8" v-if="formLeft.certificateType === '3'">
            <FormItem label="法人驾驶证"
                      v-if="formLeft.certificateType === '3'"
                      style="margin-bottom:15px;width:300px"
                      class="flex-direction requiredItem"
                      prop="driverLicense">
              <Upload :before-upload="beforeUploadHandler"
                      :on-format-error="formatErrorHandler"
                      :on-success="(res,file,fileList)=>{successHandler(res,file,fileList,'driverLicense')}"
                      :on-remove="(file,fileList)=>{removeHandler (file,fileList,'driverLicense')}"
                      :action="ImgUrl"
                      :data="{prefix:''}"
                      :show-upload-list="false"
                      :format="['jpg','jpeg','png','pdf']"
              ...
              <div class="out-img-box"
                   v-if="formLeft.driverLicense !==''">
                <div class="inner img-box">
                  <a :href="formLeft.driverLicense"
                     target="_blank"
                     class="show-pdf">
                    法人驾驶证
                  </a>
                  <Button class="deletBtn">
                    <img @click="removeHandler(1,1,'driverLicense')"
                         class="closeImg"
                         v-if="!notChange"
                         src="@/assets/images/common/activeCloseImg.png"
                         alt="">
          ...
          <Row>
            ...
            <FormItem label="法人英文姓名"
              ...
              <Input v-model="formLeft.companyLegalPersonEn"
                     placeholder="请用拼音输入"
                     :disabled="notChange"></Input>
              <p style="font-size: 14px;font-weight: 400;color: #FBB73C;line-height: 18px;margin-top: 10px;">注：英文姓名需要“名在前姓在后”（如张三，San Zhang）</p>
            </FormItem>
            </Col>
            <Col :span="8">
        ...
        <div class="item-content">
          <Row>
            ...
            <FormItem label="店铺所在电商平台"
              ...
              <RadioGroup v-model="formLeft.shopSalePlatformName">
                <Radio label="亚马逊"
                       :disabled="notChange">亚马逊</Radio>
                <Radio label="eBay"
                       :disabled="notChange">eBay</Radio>
                <Radio label="其它"
          ...
          <Row>
            ...
            <FormItem label="公司邮编号码"
                      ...
                      style="width:300px"
                      prop="shopPostCode">
              <Input v-model="formLeft.shopPostCode"
          ...
          <Row>
            ...
            <FormItem label="公司英文地址"
              ...
              <div style="display:block;">
                <Input type="text"
                       ...
                       :disabled="notChange"
                       style="margin-right:8px;margin-left:0px;display:block;" />
              </div>
            ...
            <FormItem label="税号生效日期:"
              ...
              <Tooltip placement="right"
                       style="position: absolute;top: 6px;left: 114px;">
                <span class="tips-icon">
                  <img src="@/assets/images/common/wenhao.png"
                       alt="">
                </span>
                <div slot="content">
                  <p>新账户：税号生效期请控制在未来2个月内，税号会等到中国时间此日期次日才会生效，从而才可以将税号绑定到店铺后台，请务必慎重选择。另建议填写月初不填月尾，因为计税是完整月计算的。</p>
                  <p>老账户：产生第一笔FBA销售时间/海外仓产生第一笔销售额时间/超过远程销售时间，哪个时间早以哪个时间为准。</p>
                </div>
              </Tooltip>
              <DatePicker type="date"
                          placeholder="请选择预计第一笔销售产生的时间"
            ...
            <FormItem label="预计未来12个月销售额"
              ...
              <Input v-model="formLeft.shopSalePlan"
                     ...
                     type="number"
                     :disabled="notChange">
              <span slot="append">GBP</span>
              </Input>
              <p style="font-size: 14px;font-weight: 400;color: #FBB73C;line-height: 18px;margin-top: 10px;">注： 请输入完整的销售额，如10W，则输入100000；</p>
            </FormItem>
            </Col>
          </Row>
          <Row>
            ...
            <FormItem label="税率:"
                      ...
                      class="requiredItem requiredItem">
              <Tooltip placement="right"
                       style="position: absolute;top: 5px;left: 52px;">
                <span class="tips-icon">
                  <img src="@/assets/images/common/wenhao.png"
                       alt=""></span>
                <div slot="content">
                  <p>标准税率：英国标准税率为20%，标准税率可以抵扣符合标准的进口增值税等。</p>
                </div>
              </Tooltip>
              <RadioGroup v-model="formLeft.shopTaxRate"
                          style="margin-left:20px;">
                <Radio label="1" :disabled="notChange">标准税率</Radio>
                <Radio label="0" :disabled="notChange" v-if="formLeft.companyType == 3">低税率</Radio>
              </RadioGroup>
            </FormItem>
            </Col>
          </Row>
          <Row>
            ...
            <FormItem label="描述下公司经营内容"
              ...
              <Input v-model="formLeft.companyBusinessModeDescribe"
                     ...
                     type="textarea"
                     :rows="3"></Input>
              <p style="font-size: 14px;font-weight: 400;color: #FBB73C;line-height: 18px;margin-top: 10px;">温馨提示：推荐使用谷歌翻译</p>
            </FormItem>
            </Col>
          </Row>
          <Row>
            <Col :span="8">
            <FormItem label="公司店铺截图:"
                      style="width:300px"
                      prop="isShopConsoleScreenshot"
                      class="requiredItem requiredItem">
              <RadioGroup v-model="formLeft.isShopConsoleScreenshot">
                <Radio label="1"
                       :disabled="notChange">有截图</Radio>
                <Radio label="2"
                       :disabled="notChange">无截图</Radio>
              </RadioGroup>
            </FormItem>
            </Col>
          </Row>
          <Row>
            <Col :span="8" v-if="formLeft.isShopConsoleScreenshot === '1'">
            <FormItem label="店铺后台公司信息页面截图"
              ...
              <div class="upload-tip">
                <a href="https://file.itaxs.com/dev/20210319/2d2f04cfe1dd40ada4c89895375b68e9.png"
                   target="_blank">
                  <img src="@/assets/images/common/searchImg.png"
                       alt="">
                  查看示例
            ...
            <Col :span="8" v-if="formLeft.isShopConsoleScreenshot === '2'">
            <FormItem label="店铺确认函"
                      v-if="formLeft.isShopConsoleScreenshot === '2'"
                      style="margin-bottom:15px;width:300px"
                      class="flex-direction"
                      prop="shopConsoleConfirmationLetter">
              <Upload :before-upload="beforeUploadHandler"
                      :on-format-error="formatErrorHandler"
                      :on-success="(res,file,fileList)=>{successHandler(res,file,fileList,'shopConsoleConfirmationLetter')}"
                      :on-remove="(file,fileList)=>{removeHandler (file,fileList,'shopConsoleConfirmationLetter')}"
                      :action="ImgUrl"
                      :data="{prefix:''}"
                      :show-upload-list="false"
                      ...
                      :disabled="notChange">
                <div class="inner"
                     @click="beforType('shopConsoleConfirmationLetter')">
                  <img class="uplad-symbol"
                       src="@/assets/images/common/uploadIcon1.png"
                       alt="">
                  <span class="uplad-word">点击上传</span>
              ...
              <div class="out-img-box"
                   v-if="formLeft.shopConsoleConfirmationLetter !==''">
                <div class="inner img-box">
                  <a :href="formLeft.shopConsoleConfirmationLetter"
                     target="_blank"
                     class="show-pdf">
                    店铺确认函
                  </a>
                  <Button class="deletBtn">
                    <img @click="removeHandler(1,1,'shopConsoleConfirmationLetter')"
                         class="closeImg"
                         v-if="!notChange"
                         src="@/assets/images/common/activeCloseImg.png"
                         alt="">
              ...
              <div class="upload-tip">
                <a href="https://pre-fdfs.itaxs.com/group1/M00/00/AF/rBLKLV-adJuAfyn0AAAv1ofoQms95.docx"
                   target="_blank">
                  <img src="@/assets/images/common/searchImg.png"
                       alt="">
                  下载确认函模板
          ...
          <Row>
            <FormItem label="其他资料（7选2，至少上传两类资料）"
                      style="margin-bottom:0px;"
                      class="requiredItem">
            </FormItem>
          </Row>

          <p style="font-size: 14px;font-weight: 400;color: #FBB73C;margin-bottom:15px;">注：支持JPG、JPEG、PNG、PDF格式上传</p>
          <Row>
            <Col :span="8">
            <FormItem label="工作证明"
                      style="margin-bottom:15px;width:300px"
              ...
              <Upload :before-upload="beforeUploadHandler"
                      ...
                      >
                <div class="inner"
                     @click="beforType('certificateOfEmployment')">
                  <img class="uplad-symbol"
                       src="@/assets/images/common/uploadIcon1.png"
                       alt="">
                  <span class="uplad-word">点击上传</span>
              ...
              <div class="out-img-box"
                   v-if="formLeft.certificateOfEmployment !==''">
                <div class="inner img-box">
                  <a :href="formLeft.certificateOfEmployment"
                     target="_blank"
                     class="show-pdf">
                    工作证明
                  </a>
                  <Button class="deletBtn">
                    <img @click="removeHandler(1,1,'certificateOfEmployment')"
                         class="closeImg"
                         v-if="!notChange"
                         src="@/assets/images/common/activeCloseImg.png"
                         alt="">
              ...
              <div class="upload-tip">
                <a href="https://file.itaxs.com/dev/20210518/5fdb1e3ba6de4dccaf5a9123dfd8a415.docx">
                  <img src="@/assets/images/common/searchImg.png"
                       alt="">
                  查看示例
                </a>
            ...
            <FormItem label="租房合同"
              ...
              <Upload :before-upload="beforeUploadHandler"
                      ...
                      >
                <div class="inner"
                     @click="beforType('leaseAgreement')">
                  <img class="uplad-symbol"
                       src="@/assets/images/common/uploadIcon1.png"
                       alt="">
                  <span class="uplad-word">点击上传</span>
              ...
              <div class="out-img-box"
                   v-if="formLeft.leaseAgreement !==''">
                <div class="inner img-box">
                  <a :href="formLeft.leaseAgreement"
                     target="_blank"
                     class="show-pdf">
                    租房合同
                  </a>
                  <Button class="deletBtn">
                    <img @click="removeHandler(1,1,'leaseAgreement')"
                         class="closeImg"
                         v-if="!notChange"
                         src="@/assets/images/common/activeCloseImg.png"
                         alt="">
              ...
              <div class="upload-tip">
                <a href="https://fdfs.itaxs.com/group1/M00/00/0D/rBLKNV6AVYGATZPqAAIHM7rZEFk849.pdf"
                   target="_blank">
                  <img src="@/assets/images/common/searchImg.png"
                       alt="">
                  查看示例
            ...
            <FormItem label="房产证"
              ...
              <Upload :before-upload="beforeUploadHandler"
                      ...
                      >
                <div class="inner"
                     @click="beforType('houseProprietaryCertificate')">
                  <img class="uplad-symbol"
                       src="@/assets/images/common/uploadIcon1.png"
                       alt="">
                  <span class="uplad-word">点击上传</span>
              ...
              <div class="out-img-box"
                   v-if="formLeft.houseProprietaryCertificate !==''">
                <div class="inner img-box">
                  <a :href="formLeft.houseProprietaryCertificate"
                     target="_blank"
                     class="show-pdf">
                    房产证
                  </a>
                  <Button class="deletBtn">
                    <img @click="removeHandler(1,1,'houseProprietaryCertificate')"
                         class="closeImg"
                         v-if="!notChange"
                         src="@/assets/images/common/activeCloseImg.png"
                         alt="">
          ...
          <Row>
            ...
            <FormItem label="结婚证"
              ...
              <Upload :before-upload="beforeUploadHandler"
                      ...
                      >
                <div class="inner"
                     @click="beforType('marriageLicense')">
                  <img class="uplad-symbol"
                       src="@/assets/images/common/uploadIcon1.png"
                       alt="">
                  <span class="uplad-word">点击上传</span>
              ...
              <div class="out-img-box"
                   v-if="formLeft.marriageLicense !==''">
                <div class="inner img-box">
                  <a :href="formLeft.marriageLicense"
                     target="_blank"
                     class="show-pdf">
                    结婚证
                  </a>
                  <Button class="deletBtn">
                    <img @click="removeHandler(1,1,'marriageLicense')"
                         class="closeImg"
                         v-if="!notChange"
                         src="@/assets/images/common/activeCloseImg.png"
                         alt="">
            ...
            <FormItem label="离婚证"
              ...
              <Upload :before-upload="beforeUploadHandler"
                      ...
                      >
                <div class="inner"
                     @click="beforType('divorceCertificate')">
                  <img class="uplad-symbol"
                       src="@/assets/images/common/uploadIcon1.png"
                       alt="">
                  <span class="uplad-word">点击上传</span>
              ...
              <div class="out-img-box"
                   v-if="formLeft.divorceCertificate !==''">
                <div class="inner img-box">
                  <a :href="formLeft.divorceCertificate"
                     target="_blank"
                     class="show-pdf">
                    离婚证
                  </a>
                  <Button class="deletBtn">
                    <img @click="removeHandler(1,1,'divorceCertificate')"
                         class="closeImg"
                         v-if="!notChange"
                         src="@/assets/images/common/activeCloseImg.png"
                         alt="">
            ...
            <FormItem label="出生证明（户口本）"
              ...
              <Upload :before-upload="beforeUploadHandler"
                      ...
                      >
                <div class="inner"
                     @click="beforType('birthCertificate')">
                  <img class="uplad-symbol"
                       src="@/assets/images/common/uploadIcon1.png"
                       alt="">
                  <span class="uplad-word">点击上传</span>
              ...
              <div class="out-img-box"
                   v-if="formLeft.birthCertificate !==''">
                <div class="inner img-box">
                  <a :href="formLeft.birthCertificate"
                     target="_blank"
                     class="show-pdf">
                    出生证/户口本
                  </a>
                  <Button class="deletBtn">
                    <img @click="removeHandler(1,1,'birthCertificate')"
                         class="closeImg"
                         v-if="!notChange"
                         src="@/assets/images/common/activeCloseImg.png"
                         alt="">
          ...
          <Row>
            ...
            <FormItem label="贷款明细"
              ...
              <Upload :before-upload="beforeUploadHandler"
                      ...
                      >
                <div class="inner"
                     @click="beforType('otherCertificate')">
                  <img class="uplad-symbol"
                       src="@/assets/images/common/uploadIcon1.png"
                       alt="">
                  <span class="uplad-word">点击上传</span>
              ...
              <div class="out-img-box"
                   v-if="formLeft.otherCertificate !==''">
                <div class="inner img-box">
                  <a :href="formLeft.otherCertificate"
                     target="_blank"
                     class="show-pdf">
                    房屋贷款明细
                  </a>
                  <Button class="deletBtn">
                    <img @click="removeHandler(1,1,'otherCertificate')"
                         class="closeImg"
                         v-if="!notChange"
                         src="@/assets/images/common/activeCloseImg.png"
                         alt="">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      ruleForm: {
        otherCertificate: [
          { required: true, trigger: "change", message: "请上传房屋贷款明细 ", }
        ],
        birthCertificate: [
          { required: true, trigger: "change", message: "请上传出生证/户口本 ", }
        ],
        houseProprietaryCertificate: [
          { required: true, trigger: "change", message: "请上传房产证 ", }
        ],
        divorceCertificate: [
          { required: true, trigger: "change", message: "请上传离婚证 ", }
        ],
        marriageLicense: [
          { required: true, trigger: "change", message: "请上传结婚证 ", }
        ],
        leaseAgreement: [
        ...
        isShopConsoleScreenshot: [
          { required: true, trigger: "change", message: "请选择是否有店铺截图 ", }
        ],
        shopTaxRate: [
          { required: true, trigger: "change", message: "请选择税率", }
        ],
        shopSalePlan: [
          { required: true, trigger: "change", validator: onlyNumber, message: "请输入销售额", }
        ],
        shopNature: [
          { required: true, trigger: "change", message: "请选择开店主体", }
        ],
        companyType: [
        ...
        bankAddress: [
          { required: true, trigger: "change", message: "请填写支行英文地址" }
        ],
        bankAccount: [
        ...
        shopSaleBeforeFile: [
          { required: true, trigger: "change", message: "请上传过往12个月销售报告" }
        ],
        companyLegalPersonEmail: [
        ...
        companyLegalPersonCard: [
          { required: true, trigger: "change", message: "请填写法人身份证号码" }
        ],
        companyLegalPersonBirthday: [
  ...
  methods: {
    ...
    shopSalePlanFun() {
      if (this.formLeft.shopSalePlan - 0 >= 150000) {
        this.formLeft.shopTaxRate = '1'
      } else {
        this.formLeft.shopTaxRate = '0'
      }
    },
    saveData() {
      if (this.formLeft.shopSalePlan < 0) {
        this.$Message.error('请输入正确的销售额')
        return
      }
      if(this.formLeft.companyType != '3' && this.formLeft.shopTaxRate == '0'){
        this.formLeft.shopTaxRate = ''
      }
     // naoki 验证英国7选2
    //  this.verifyOtherData()
    //  if (this.otherFileList.length < 2) { 
    //     this.$Message.warning('其他证明文件为7选2，至少上传两类资料！');
    //    return false
    //  }
    ...
    verifyOtherData (){
      this.otherFileList = []
      if (this.formLeft.certificateOfEmployment != '') {
        this.otherFileList.push(this.formLeft.certificateOfEmployment)
      }
      if (this.formLeft.leaseAgreement != '') {
        this.otherFileList.push(this.formLeft.leaseAgreement)
       }
      if (this.formLeft.marriageLicense != '') {
        this.otherFileList.push(this.formLeft.marriageLicense)
      }
       if (this.formLeft.divorceCertificate != '') {
         this.otherFileList.push(this.formLeft.divorceCertificate)
      }          
      if (this.formLeft.houseProprietaryCertificate != '') {
         this.otherFileList.push(this.formLeft.houseProprietaryCertificate)
      }    
      if (this.formLeft.birthCertificate != '') {
        this.otherFileList.push(this.formLeft.birthCertificate)
      }          
      if (this.formLeft.otherCertificate != '') {
        this.otherFileList.push(this.formLeft.otherCertificate)
      }
    },

    submitData() {
      let self = this
      if (self.formLeft.shopSalePlan < 0) {
        this.$Message.error('请输入正确的销售额')
        return
      }
      if(this.formLeft.companyType != '3' && this.formLeft.shopTaxRate == '0'){
