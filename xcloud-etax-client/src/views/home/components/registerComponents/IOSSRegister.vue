    ...
    <div class="content">
      <Form :model="formLeft" class="formstyle inputHFlex" :rules="ruleForm" ref="formLeft">
        <div class="item-content">
          <Row>
            <Col :span="8">
              <FormItem label="公司类型" prop="companyType" style="width: 300px">
                <RadioGroup v-model="formLeft.companyType" @on-change="companyTypeChange($event)">
                  <Radio :disabled="notChange" label="1">大陆公司</Radio>
                  <Radio :disabled="notChange" label="2">香港公司</Radio>
                  <Radio :disabled="notChange" label="3">境外公司</Radio>
                </RadioGroup>
              </FormItem>
            </Col>
          </Row>
          ...
          <Row>
            <Col :span="8">
              ...
              >
                ...
                <div class="out-img-box" v-if="formLeft.companyBusinessLicense">
                  <div class="inner img-box">
                    <a :href="formLeft.companyBusinessLicense" target="_blank" class="show-pdf"> 英文营业执照 </a>
                    <Button class="deletBtn">
                      <img
                        @click="removeHandler(1, 1, 'companyBusinessLicense')"
                        class="closeImg"
                ...
                <div class="upload-tip">
                  <a href="http://file.itaxs.com/dev/20210720/d57577ba5f3f44069204541d12cd456c.pdf" target="_blank">
                    <img src="@/assets/images/common/searchImg.png" alt="" />
                    查看示例
                  </a>
                </div>
            ...
            <Col :span="8">
              ...
              >
                ...
                <div class="out-img-box" v-if="formLeft.articlesOfAssociationFile">
                  <div class="inner img-box">
                    <a :href="formLeft.articlesOfAssociationFile" target="_blank" class="show-pdf"> 英文公司章程 </a>
                    <Button class="deletBtn">
                      <img
          ...
          <Row>
            <Col :span="8">
              <FormItem label="公司中文名称：" class="requiredItem" style="width: 300px" prop="companyNameZh">
                <AutoComplete
            ...
            <Col :span="8">
              <FormItem label="公司邮箱：" style="width: 300px" prop="companyEmail">
                <Input v-model="formLeft.companyEmail" placeholder="请输入公司邮箱" :disabled="notChange"></Input>
              </FormItem>
            </Col>
          </Row>
          <Row>
            <Col :span="8">
              <FormItem label="公司英文地址：" style="width: 300px" prop="companyAddressEn">
                <Input
              ...
              <p style="font-size: 14px; font-weight: 400; color: #fbb73c">注：根据营业执照地址填写</p>
            </Col>
            <Col :span="8">
              <FormItem label="公司电话：" style="width: 300px">
                <Input v-model="formLeft.companyTel" placeholder="请输入公司电话" :disabled="notChange"></Input>
              </FormItem>
            </Col>
            <!-- gsw 新增字段 -->
            <Col :span="8">
              <FormItem label="社会统一信用代码：" style="width: 300px" prop="companyCreditCode">
                <Input v-model="formLeft.companyCreditCode" placeholder="请输入社会统一信用代码" :disabled="notChange"></Input>
                <p style="font-size: 14px; font-weight: 400; color: #fbb73c">注：请填写与营业执照一致的信用代码</p>
              </FormItem>
            </Col>
          </Row>
        </div>
        ...
        <div class="item-content">
          <Row>
            <Col :span="8">
              <FormItem label="证件类型" style="width: 300px" prop="certificateType">
          ...
          <Row>
            <Col :span="8">
              <FormItem label="法人中文姓名" prop="companyLegalPersonZh" style="width: 300px">
                <Input
            ...
            <Col :span="8">
              <FormItem label="法人英文姓名" prop="companyLegalPersonEn" style="width: 300px">
          ...
          <Row>
            ...
            <div class="legalPersonSignature">
              <p class="titleSign requiredItem">
                法人签名
              </p>

              <div class="flex">
                <div id="qrcode"
                    v-show="status == 0 || status == 8">
                </div>
                <div class="signature">
                  ...
                  <span v-if="(status == 0 || status == 8) && (formLeft.companyLegalPersonSign !== '' && formLeft.companyLegalPersonSign !== undefined)"
                        @click="hasSignature">
                    <img class="refresh"
              ...
              <p style="font-size: 14px;font-weight: 400;color: #FBB73C;line-height: 18px;margin-top:10px;">
                说明：法人签名主要应用于注册税号POA授权,请使用英文格式签名，如张三（San Zhang）
        ...
        <div class="item-content">
          <Row>
            <Col :span="12">
              <FormItem label="站点类型：" prop="shopSalePlatformName" class="requiredItem">
                <RadioGroup v-model="formLeft.shopSalePlatformName">
                  <Radio label="Amazon" :disabled="notChange" style="margin-right: 20px">Amazon</Radio>
                  <Radio label="eBay" :disabled="notChange" style="margin-right: 20px">eBay</Radio>
                  <Radio label="速卖通" :disabled="notChange" style="margin-right: 20px">速卖通</Radio>
                  <Radio label="独立站/自建站" :disabled="notChange" style="margin-right: 20px">独立站/自建站</Radio>
                  <Radio label="其他" :disabled="notChange">其他</Radio>
                </RadioGroup>
              </FormItem>
            </Col>
          </Row>
          <Row>
            <Col :span="8">
              <FormItem label="销售网站链接：" prop="shopHref" style="width: 300px">
                <Input
            ...
            <Col :span="8">
              <FormItem label="商品销往国：" prop="productSalesCountry" style="width: 300px">
                <Input
                  v-model="formLeft.productSalesCountry"
          ...
          <Row>
            <Col :span="8">
              <FormItem label="任一欧盟国家税号：（一个即可）" prop="taxVatCountry" style="width: 300px">
                <Input
                  v-model="formLeft.taxVatCountry"
                  placeholder="税号国家（中文）"
                  style="width: 130px"
                  :disabled="notChange"
                ></Input>
            ...
            <Col :span="8">
              <FormItem label="该国税号文件：" style="margin-bottom: 15px; width: 300px" class="flex-direction">
                <Upload
                  :before-upload="beforeUploadHandler"
                  :on-format-error="formatErrorHandler"
                  :on-success="
                ...
                <div class="out-img-box" v-if="formLeft.vatTaxEuFile">
                  <div class="inner img-box">
                    <a :href="formLeft.vatTaxEuFile" target="_blank" class="show-pdf"> 该国税号文件 </a>
                    <Button class="deletBtn">
                      <img
                ...
                <p style="font-size: 14px; font-weight: 400; color: #fbb73c">注：支持JPG、JPEG、PNG、PDF格式上传</p>
                <div class="upload-tip">
                  <a href="http://file.itaxs.com/dev/20210705/ab68e2f7c291475b9694484ae4e9522a.pdf" target="_blank">
                    <img src="@/assets/images/common/searchImg.png" alt="" />
                    查看示例
                  </a>
                </div>
          ...
          <Row>
            <Col :span="8">
              <FormItem label="税号生效日期:" prop="shopTaxEffectiveData" style="width: 300px">
                <DatePicker
                  type="date"
                  :options="datePicker"
        ...
        <div class="title">
          银行信息&nbsp;&nbsp;&nbsp;<span style="font-size: 12px; font-weight: 400; color: #fbb73c"
            >提示：可以是第三方平台境外转账卡号信息</span
          >
        </div>
        <div class="item-content">
          <Row>
            <Col :span="8">
              <FormItem label="IBAN（银行卡号）：" class="requiredItem" prop="bankAccount" style="width: 300px">
                <Input
            ...
            <Col :span="8">
              <FormItem label="BIC（银行识别码）：" class="requiredItem" prop="swiftBic" style="width: 300px">
                <Input v-model="formLeft.swiftBic" placeholder="请输入IBAN（银行卡号）" :disabled="notChange"></Input>
              </FormItem>
            </Col>
          </Row>
          <Row>
            ...
            <Col :span="8">
              <FormItem
                label="Account address（账号地址）："
                class="requiredItem"
                prop="bankAddressEn"
                style="width: 300px"
              >
                <Input
                  v-model="formLeft.bankAddressEn"
...
export default {
  ...
  data() {
    ...
    return {
      ...
      ruleForm: {
        otherTaxCertificate: [{ required: true, trigger: "change", message: "请上传完税/纳税证明" }],
        storageAddressCountry: [{ required: true, trigger: "change", message: "请输入仓储地址国家" }],
        otherEoriNumber: [{ required: true, trigger: "change", message: "请输入欧盟国EORI号" }],
        isThereEoriNumber: [{ required: true, trigger: "change", message: "请选择是否有欧盟国EORI号" }],
        isOtherGulfStateDutyOrServices: [{ required: true, trigger: "change", message: "请选择是否有其他欧盟VAT" }],
        shopOtherEuTaxNumber: [{ required: true, trigger: "change", message: "请输入VAT增值税号" }],
        articlesOfAssociationFile: [{ required: true, trigger: "change", message: "请上传公司章程" }],
        bankAccountCertify: [{ required: true, trigger: "change", message: "请上传银行账户证明" }],
        bankAddressEn: [{ required: true, trigger: "change", message: "请输入银行英文地址" }],
        bankAccountAddressEn: [{ required: true, trigger: "change", message: "请输入账户主体地址" }],
        bankAccountAddressPostcode: [{ required: true, trigger: "change", message: "请输入所在地邮编号码：" }],
        legalPersonPostCode: [{ required: true, trigger: "change", message: "请输入法人身份证所在地邮编号码" }],
        otherCertificate: [{ required: true, trigger: "change", message: "请上传房屋贷款明细 " }],
        birthCertificate: [{ required: true, trigger: "change", message: "请上传出生证/户口本 " }],
        houseProprietaryCertificate: [{ required: true, trigger: "change", message: "请上传房产证 " }],
        divorceCertificate: [{ required: true, trigger: "change", message: "请上传离婚证 " }],
        marriageLicense: [{ required: true, trigger: "change", message: "请上传结婚证 " }],
        ...
        personCardAddressEn: [{ required: true, trigger: "change", message: "请输入法人身份证英文地址 " }],
        shopConsoleConfirmationLetter: [{ required: true, trigger: "change", message: "请上传店铺确认函 " }],
        isShopConsoleScreenshot: [{ required: true, trigger: "change", message: "请选择是否有店铺截图 " }],
        shopTaxRate: [{ required: true, trigger: "change", message: "请选择税率" }],
        shopSalePlan: [{ required: true, trigger: "change", validator: onlyNumber, message: "请输入销售额" }],
        ...
        shopSaleBefore: [{ required: true, trigger: "change", message: "请填写阿拉伯数字", validator: onlyNumber }],
        future30Sale: [{ required: true, trigger: "change", message: "请填写阿拉伯数字", validator: onlyNumber }],
        shopSalePlatformName: [{ required: true, trigger: "change", message: "请选择店铺所在电商平台" }],
        swiftBic: [{ required: true, trigger: "change", message: "请填写BIC（银行识别码）" }],
        bankAddress: [{ required: true, trigger: "change", message: "请填写支行英文地址" }],
        bankAccount: [{ required: true, trigger: "change", message: "请填写IBAN/银行账户" }],
        bankSubBranchName: [{ required: true, trigger: "change", message: "请填写支行名称" }],
        bankName: [{ required: true, trigger: "change", message: "请填写银行名称" }],
        bankAccountName: [{ required: true, trigger: "change", message: "请填写账户名称" }],
        companyPostCode: [{ required: true, trigger: "change", message: "请填写邮政编码" }],
        profession: [{ required: true, trigger: "change", message: "请填写职业" }],
        shopSalePlatformAccount: [{ required: true, trigger: "change", message: "请填写电商平台账号完整名称" }],
        shopSaleBeforeFile: [{ required: true, trigger: "change", message: "请上传过往12个月销售报告" }],
        companyLegalPersonEmail: [
          { required: true, trigger: "change", message: "请填写法人联系邮箱" },
          { type: "email", message: "请填写正确邮箱", trigger: "change" },
        ],
        companyLegalPersonMobile: [{ required: true, trigger: "change", message: "请填写常用联系手机号" }],
        companyRegisteredCityZh: [{ required: true, trigger: "change", message: "请填公司营业执照注册城市" }],
        localBankAccountInfo: [{ required: true, trigger: "change", message: "请填写本地银行账户信息" }],
        vatTaxNumber: [{ required: true, trigger: "change", message: "请填写VAT税号" }],
        declarePeriod: [{ required: true, trigger: "change", message: "请选择报税周期" }],
        companyNameZh: [{ required: true, trigger: "change", message: "请填写公司中文名" }],
        companyLegalPersonZh: [{ required: true, trigger: "change", message: "请填写法人中文名" }],
        companyLegalPersonEn: [{ required: true, trigger: "change", message: "请填写法人英文名" }],
        companyNameEn: [{ required: true, trigger: "change", message: "请填写公司英文名" }],
        companyLegalPersonBirthplace: [{ required: true, trigger: "change", message: "请填写法人出生地" }],
        companyLegalPersonSign: [{ required: true, trigger: "change", message: "请填写上传法人签名" }],
        companyLegalPersonCardAddress: [{ required: true, trigger: "change", message: "请填写法人身份证英文地址" }],
        companyLegalPersonCard: [{ required: true, trigger: "change", message: "请填写法人身份证号码" }],
        legalPersonCardPassportNumber: [{ required: true, trigger: "change", message: "请填写法人护照号码" }],
        companyLegalPersonBirthday: [
        ...
        shopHref: [{ required: true, trigger: "change", message: "请填写销售网站链接" }],
        productSalesCountry: [{ required: true, trigger: "change", message: "请填写商品销往国" }],
        shippingProcess: [{ required: true, trigger: "change", message: "请填写货物进口及配送流程" }],
        companyAddressEnCountry: [{ required: true, trigger: "change", message: "请填写公司英文地址" }],
        companyAddressEn: [{ required: true, trigger: "change", message: "请填写公司英文地址" }],
        companyCreditCode: [{ required: true, trigger: "change", message: "请填写统一社会信用代码" }],
        legalPersonBirthplaceProvinceZh: [{ required: true, trigger: "change", message: "请填写法人的出生省份中文" }],
        legalPersonBirthplaceProvinceEn: [{ required: true, trigger: "change", message: "请填写法人的出生省份英文" }],
        legalPersonBirthplaceCityZh: [{ required: true, trigger: "change", message: "请填写法人的出生城市中文" }],
        legalPersonBirthplaceCityEn: [{ required: true, trigger: "change", message: "请填写法人的出生城市英文" }],
        companyLegalPersonCardAddressZh: [{ required: true, trigger: "change", message: "请填写法人身份证中文地址" }],
        companyRegisteredCapital: [
          {
            required: true,
            trigger: "blur",
            validator: onlyNumber,
            message: "请输入公司注册资本（万元）",
            type: "number",
          },
        ],
        companyRegisterData: [
        ...
        companyTel: [{ required: true, trigger: "change", message: "请填写公司电话" }],
        companyBusinessModeDescribe: [{ required: true, trigger: "change", message: "请填写公司经营内容" }],
        shopTaxEffectiveData: [
          {
            required: true,
            trigger: "change",
  ...
  methods: {
    ...
    // 是否使用捷克仓
    isUseCZStoreChange(val) {
      if (val == 2) {
        this.$Modal.info({
          title: "温馨提示",
          content: `<p>如您不使用捷克任何仓，税局会默认</p><p>无需申请捷克税号，请谨慎选择</p>`,
        });
      }
    },
    ...
    successHandler(res, file, fileList, item) {
      ...
      self.$set(self.formLeft, item, res.data.fileUrl);
      if (res.size > 4096) {
        return;
      }
    ...
    submitData() {
      let self = this;
      self.$refs["formLeft"].validate((valid) => {
        if (valid) {
          let data = { ...self.formLeft };
          // 因营业执照和商业登记证/海外证书在接口定义时用的字段都是companyBusinessLicense
          // if(self.formLeft.companyType == 3){
          //   data.companyBusinessLicense = self.formLeft.companyBusinessLicenseCopy;
          // }
          if (!["Amazon", "eBay", "速卖通", "独立站/自建站", "其他"].includes(self.formLeft.shopSalePlatformName)) {
            this.$Message.warning("请选择店铺所在电商平台");
            return;
          }
          self.translateDate(data);
          getMaterialSubmit(data)
            .then(
              (res) => {
                if (res.code == 0) {
                  self.$Message.success("提交资料成功");
                  self.$emit("submitSuccess", res.timestamp);
                } else {
