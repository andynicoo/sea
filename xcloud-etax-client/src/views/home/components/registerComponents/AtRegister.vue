      ...
      <Form :model="formLeft"
        ...
        <div class="item-content">
          ...
          <Row>
            ...
            <Col :span="8">
            <FormItem label="公司联系邮箱"
                      style="width:300px;"
                      prop="companyEmail">
              <Input v-model="formLeft.companyEmail"
                     placeholder="请输入常用的联系邮箱"
                     :disabled="notChange"></Input>
            </FormItem>
            </Col>
            <Col :span="8">
        ...
        <div class="item-content">
          ...
          <Row>
            ...
            <FormItem label="店铺名称"
                      ...
                      style="width:300px;"
                      prop="shopName">
              <Input v-model="formLeft.shopName"
                     placeholder="请输入店铺名称"
                     :disabled="notChange"></Input>
            </FormItem>
            </Col>
          ...
          <Row>
            ...
            <FormItem label="欧盟站点店铺后台链接"
                      style="width:300px;"
                      prop="shopHref">
              <Input v-model="formLeft.shopHref"
                     placeholder="请输入欧盟站点店铺后台链接"
                     :disabled="notChange"></Input>
              <p style="font-size: 14px;font-weight: 400;color: #FBB73C;line-height: 18px;margin-top: 10px;">注：建议德国站点店铺后台链接</p>
            </FormItem>
            </Col>
            <Col :span="8">
              ...
              <Tooltip placement="right"
                ...
                <span class="tips-icon">
                  <img src="@/assets/images/common/wenhao.png"
                       alt=""></span>
                <div slot="content">
                  <p>如有销售，则填写第一笔发FBA订单时间；</p>
                  <p>如无销售（新账号），则填写往后一个月左右即可；</p>
                </div>
              </Tooltip>
              <DatePicker type="date"
                          :options="datePicker"
          ...
          <Row>
            ...
            <Col :span="8">
            <FormItem label="预计第二年销售额："
                      class="requiredItem"
                      style="width:300px;"
                      prop="future2YearSale">
              <Input v-model="formLeft.future2YearSale"
            ...
            <Col :span="8">
            <FormItem label="是否有其他欧盟VAT"
                      style="width:300px;"
                      class="requiredItem flex-direction "
                      prop="isOtherGulfStateDutyOrServices">
              <RadioGroup v-model="formLeft.isOtherGulfStateDutyOrServices">
                <Radio label="1"
                       :disabled="notChange">有</Radio>
                <Radio label="2"
                       :disabled="notChange">无</Radio>
              </RadioGroup>
            </FormItem>
            </Col>
          </Row>
          <Row>
            <Col :span="8">
            <FormItem label="VAT增值税号"
                      style="width:300px;"
                      v-if="formLeft.isOtherGulfStateDutyOrServices === '1'"
                      class="requiredItem"
            ...
            <Col :span="8">
            <FormItem label="是否有欧盟EORI号"
                      class="requiredItem flex-direction "
                      style="width:300px;"
                      prop="isThereEoriNumber">
            ...
            <Col :span="8">
            <FormItem label="欧盟国EORI号"
                      v-if="formLeft.isThereEoriNumber === '1'"
                      style="width:300px;"
                      class="requiredItem"
                      prop="otherEoriNumber">
              <Input v-model="formLeft.otherEoriNumber"
          ...
          <Row>
            <Col :span="8">
            <FormItem label="仓储地址国家："
                      class="requiredItem"
                      style="width:300px;"
                      prop="storageAddressCountry">
              <Input v-model="formLeft.storageAddressCountry"
            ...
            <FormItem label="完税/纳税证明"
              ...
              <Upload :before-upload="beforeUploadHandler"
                      ...
                      :disabled="notChange">
                <div class="inner"
                     @click="beforType('otherTaxCertificate')">
                  <img class="uplad-symbol"
                       src="@/assets/images/common/uploadIcon1.png"
                       alt="">
                  <span class="uplad-word">点击上传</span>
              ...
              <div class="out-img-box"
                   v-if="formLeft.otherTaxCertificate !==''">
                <div class="inner img-box">
                  <a :href="formLeft.otherTaxCertificate"
                     target="_blank"
                     class="show-pdf">
                    完税/纳税证明
                  </a>
                  <Button class="deletBtn">
                    <img @click="removeHandler(1,1,'otherTaxCertificate')"
                         class="closeImg"
                         v-if="!notChange"
                         src="@/assets/images/common/activeCloseImg.png"
                         alt="">
        ...
        <div class="item-content">
          ...
          <Row>
            <Col :span="8">
            <FormItem label="银行Swift / BIC："
                      class=""
                      style="width:300px;">
              <Input v-model="formLeft.swiftBic"
                     placeholder="请输入银行Swift / BIC"
                     :disabled="notChange"></Input>
            </FormItem>
            </Col>
...
import { getMaterialSubmit, getRegTaxDetail, getMaterialSave, getAllServiceCompanies, getCompanyInformation, getCompanyLegalPersonSign, getCompanyLegalPersonSignUrl } from "@/api/registerInfo/registerInfo";
...
export default {
  ...
  data() {
    ...
    return {
      ...
      ruleForm: {
        otherTaxCertificate: [
          { required: true, trigger: "change", message: "请上传完税/纳税证明" }
        ],
        shopName: [
          { required: true, trigger: "change", message: "请输入店铺名称" }
        ],
        storageAddressCountry: [
          { required: true, trigger: "change", message: "请输入仓储地址国家" }
        ],
        otherEoriNumber: [
          { required: true, trigger: "change", message: "请输入欧盟国EORI号" }
        ],
        isThereEoriNumber: [
          { required: true, trigger: "change", message: "请选择是否有欧盟国EORI号", }
        ],
        isOtherGulfStateDutyOrServices: [
          { required: true, trigger: "change", message: "请选择是否有其他欧盟VAT", }
        ],
        shopOtherEuTaxNumber: [
          { required: true, trigger: "change", message: "请输入VAT增值税号", }
        ],
        shopSalePlan: [
          { required: true, trigger: "change", validator: onlyNumber, message: "请输入预计第一年销售额", }
        ],
        future2YearSale: [
          { required: true, trigger: "change", validator: onlyNumber, message: "请输入预计第二年销售额", }
        ],
        articlesOfAssociationFile: [
          { required: true, trigger: "change", message: "请上传公司章程", }
        ],
        bankAccountCertify: [
          { required: true, trigger: "change", message: "请上传银行账户证明", }
        ],
        bankAddressEn: [
          { required: true, trigger: "change", message: "请输入银行英文地址", }
        ],
        bankAccountAddressEn: [
          { required: true, trigger: "change", message: "请输入账户主体地址", }
        ],
        bankAccountAddressPostcode: [
          { required: true, trigger: "change", message: "请输入所在地邮编号码：", }
        ],
        legalPersonPostCode: [
          { required: true, trigger: "change", message: "请输入法人身份证所在地邮编号码", }
        ],
        otherCertificate: [
        ...
        personCardAddressEn: [
          { required: true, trigger: "change", message: "请输入法人身份证英文地址 ", }
        ],
        shopConsoleConfirmationLetter: [
        ...
        legalPersonCardPassportNumber: [
          { required: true, trigger: "change", message: "请填写法人护照号码" }
        ],
        companyLegalPersonBirthday: [
        ...
        companyRegisteredCapital: [
          { required: true, trigger: "blur", validator: onlyNumber, message: "请输入公司注册资本（万元）", type: "number" }
        ],
        companyRegisterData: [
          {
            required: true,
  ...
  methods: {
    ...
    saveData() {
      ...
      if (this.formLeft.future2YearSale < 0) {
        this.$Message.error('请输入预计第二年销售额')
        return
      }
      if (this.formLeft.shopSalePlan < 0) {
        this.$Message.error('请输入预计第一年销售额')
        return
      }
    ...
    submitData() {
      let self = this
      if (self.formLeft.companyRegisteredCapital < 0) {
        this.$Message.error('请输入正确的公司资本')
        return
      }
      if (self.formLeft.future2YearSale < 0) {
        this.$Message.error('请输入预计第二年销售额')
        return
      }
