    ...
    <div class="content">
      <Form :model="formLeft" class="formstyle inputHFlex" :rules="ruleForm" ref="formLeft">
        <div class="item-content">
            ...
            <Col :span="8">
              ...
              >
                <Upload
                  ...
                  :disabled="notChange"
                >
                  <div class="inner" @click="beforType('companyCreditReport')">
                    <img class="uplad-symbol" src="@/assets/images/common/uploadIcon1.png" alt="" />
                    <span class="uplad-word">点击上传</span>
                  </div>
                </Upload>
                <div class="out-img-box" v-if="formLeft.companyCreditReport !== ''">
                  <div class="inner img-box">
                    <a :href="formLeft.companyCreditReport" target="_blank" class="show-pdf"> 公司信用报告 </a>
                    <Button class="deletBtn">
                      <img
                        @click="removeHandler(1, 1, 'companyCreditReport')"
                        class="closeImg"
                        v-if="!notChange"
                        src="@/assets/images/common/activeCloseImg.png"
                        alt=""
                ...
                <div class="upload-tip">
                  <a href="https://fdfs.itaxs.com/group1/M00/00/1F/rBLKNV6n0kKAU23YAASrdiyBiIs540.pdf" target="_blank">
                    <img src="@/assets/images/common/searchImg.png" alt="" />
                    查看示例
                  </a>
                </div>
              ...
              >
                ...
                <div class="out-img-box" v-if="formLeft.companyCreditReport !== ''">
                  <div class="inner img-box">
                    <a :href="formLeft.companyCreditReport" target="_blank" class="show-pdf"> 股东信息文件 </a>
                    <Button class="deletBtn">
                      <img
                        @click="removeHandler(1, 1, 'companyCreditReport')"
                        class="closeImg"
                ...
                <div class="upload-tip">
                  <a href="https://file.itaxs.com/dev/20210319/70452f9c76a04fbe908b210fa0f5c4dc.pdf" target="_blank">
                    <img src="@/assets/images/common/searchImg.png" alt="" />
                    查看示例
                  </a>
                </div>
          ...
          <Row>
            <Col :span="8">
              ...
              >
                <Input
                  v-model="formLeft.companyAddressZh"
                  type="textarea"
            ...
            <Col :span="8">
              <FormItem
                ...
                class="requiredItem"
                style="width: 300px"
                prop="companyRegisteredCityEn"
              >
                <Input
                  v-model="formLeft.companyRegisteredCityEn"
                  type="textarea"
                  placeholder="请输入营业执照的登记城市 如 shenzhen"
                  :disabled="notChange"
                ></Input>
                <p style="font-size: 14px; font-weight: 400; color: #fbb73c">注：请与营业执照登记机关所在城市一致</p>
              </FormItem>
            </Col>
          </Row>
          <Row>
            <Col :span="8">
              ...
              >
                <Select v-model="formLeft.companyCitizenship" placeholder="请选择公司国籍" :disabled="notChange">
        ...
        <div class="item-content">
          <Row>
            <Col :span="8">
              <FormItem label="证件类型" prop="certificateType" class="requiredItem" style="width: 300px">
                <RadioGroup v-model="formLeft.certificateType">
                  <Radio :disabled="notChange" label="1">身份证</Radio>
          ...
          <Row>
            <Col :span="8">
              <FormItem label="法人中文姓名" class="requiredItem" style="width: 300px" prop="companyLegalPersonZh">
                <Input
            ...
            <Col :span="8" v-if="formLeft.certificateType === '1'">
              <FormItem label="法人身份证号码" class="requiredItem" style="width: 300px" prop="companyLegalPersonCard">
                <Input
            ...
            <Col :span="8" v-if="formLeft.certificateType === '2'">
              <FormItem label="法人护照号码：" class="requiredItem" style="width: 300px" prop="companyLegalPersonCard">
                <Input
                  v-model="formLeft.companyLegalPersonCard"
                  placeholder="请填写护照号码"
                  :disabled="notChange"
          ...
          <Row>
            ...
            <Col :span="8">
              <FormItem
                ...
                class="requiredItem"
                style="width: 300px"
                prop="legalPersonBirthplaceProvinceEn"
              >
                <Input
                  v-model="formLeft.legalPersonBirthplaceProvinceEn"
                  placeholder="请输入英文，如guangdong"
                  :disabled="notChange"
                ></Input>
              </FormItem>
            </Col>
            <Col :span="8">
              ...
              >
                <Input
                  ...
                  :disabled="notChange"
                ></Input>
                <p style="font-size: 14px; font-weight: 400; color: #fbb73c; line-height: 18px">
                  注：请用拼音输入身份证地址；
                </p>
              </FormItem>
            </Col>
          ...
          <Row>
            ...
            <Col :span="8">
              <FormItem
                ...
                class="requiredItem"
                style="width: 300px"
                prop="companyLegalPersonMaritalStatus"
              >
                <RadioGroup v-model="formLeft.companyLegalPersonMaritalStatus">
                  <Radio label="1" :disabled="notChange">未婚</Radio>
                  <Radio label="2" :disabled="notChange">已婚</Radio>
                  <Radio label="3" :disabled="notChange">离异</Radio>
                  <Radio label="4" :disabled="notChange">丧偶</Radio>
                </RadioGroup>
              </FormItem>
            </Col>
          </Row>
          <Row>
            <Col :span="8">
              <FormItem
                label="法人身份证所在城市的英文名称："
                class="requiredItem"
                style="width: 300px"
                prop="personCardAddressCityEn"
              >
                <Input
            ...
            <Col :span="8">
              <div class="legalPersonSignature">
                <p class="titleSign requiredItem">法人签名</p>

                <div class="flex">
                  <div id="qrcode" v-show="status == 0 || status == 8"></div>
                  <div class="signature">
                    <img
        ...
        <div class="item-content">
          ...
          <Row>
            ...
            <Col :span="8">
              <FormItem label="公司邮编号码" class="requiredItem" style="width: 300px" prop="shopPostCode">
                <Input v-model="formLeft.shopPostCode" placeholder="请输入公司邮编号码" :disabled="notChange"></Input>
              </FormItem>
            </Col>
          </Row>
          <Row>
            <Col :span="8">
              <FormItem label="公司英文地址" class="requiredItem" style="width: 300px" prop="companyAddressEn">
            ...
            <Col :span="8">
              ...
              >
                <Upload
                  ...
                  :disabled="notChange"
                >
                  <div class="inner" @click="beforType('amazonProveFile')">
                    <img class="uplad-symbol" src="@/assets/images/common/uploadIcon1.png" alt="" />
                    <span class="uplad-word">点击上传</span>
                  </div>
                </Upload>
                <div class="out-img-box" v-if="formLeft.amazonProveFile !== ''">
                  <div class="inner img-box">
                    <a :href="formLeft.amazonProveFile" target="_blank" class="show-pdf"> 亚马逊证明文件 </a>
                    <Button class="deletBtn">
                      <img
                        @click="removeHandler(1, 1, 'amazonProveFile')"
                        class="closeImg"
                        v-if="!notChange"
                        src="@/assets/images/common/activeCloseImg.png"
                        alt=""
            ...
            <Col :span="8">
              ...
              >
                ...
                <div class="out-img-box" v-if="formLeft.vatTaxEuFile !== ''">
                  <div class="inner img-box">
                    <a :href="formLeft.vatTaxEuFile" target="_blank" class="show-pdf"> 其他欧盟税号文件 </a>
                    <Button class="deletBtn">
                      <img
            ...
            <Col :span="8">
              ...
              >
                ...
                <div class="out-img-box" v-if="formLeft.shopConsoleScreenshot !== ''">
                  <div class="inner img-box">
                    <a :href="formLeft.shopConsoleScreenshot" target="_blank" class="show-pdf"> 店铺后台截图 </a>
                    <Button class="deletBtn">
                      <img
                ...
                <p style="font-size: 14px; font-weight: 400; color: #fbb73c">注：支持JPG、JPEG、PNG、PDF格式上传</p>
                <div class="upload-tip">
                  <a href="https://fdfs.itaxs.com/group1/M00/00/27/rBLKNV61CJKACMtaAAtFQeS7riM549.pdf" target="_blank">
                    <img src="@/assets/images/common/searchImg.png" alt="" />
                    查看示例
                  </a>
                </div>
...
import { identifyBusinessLicense, identifyIdCard, legalpersonCountry } from "@/api/taxModule";
export default {
  ...
  data() {
    ...
    return {
      ...
      ruleForm: {
        companyAddressZh: [{ required: true, trigger: "change", message: "请输入您的公司地址" }],
        amazonProveFile: [{ required: true, trigger: "change", message: "请上传亚马逊证明文件" }],
        ...
        companyRegisteredCityEn: [{ required: true, trigger: "blur", message: "请输入营业执照的登记城市英文名" }],
    ...
    leftFrom: {
      ...
      handler(val, oldval) {
        if (JSON.stringify(val) != "{}") {
          ...
          this.formLeft.companyLegalPersonMaritalStatus = String(val.companyLegalPersonMaritalStatus)
        }
      },
    },
  },
