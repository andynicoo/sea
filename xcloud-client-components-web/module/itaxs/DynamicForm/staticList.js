import { getEnumObj } from '@comp/utils/util.js';
...
export const currentCodeEnum = getEnumObj(currentCodeList);
...
export const companyInformation = [
  ...
  'businesslicenseissuancedate',
  'regionCode',
  'companyRegisteredCapitalCny',
];
//法人信息自动识别字段
export const legalPersonInformation = [
