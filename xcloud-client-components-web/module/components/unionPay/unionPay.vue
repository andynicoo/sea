      ...
      <div class="content">
        <div class="count-info">
          ...
          <div style="text-align: center">
            ...
            <Button v-else style="margin-top: 15px; margin-bottom: 30px" @click="submit" :loading="submitLoading"
              >提交</Button
            >
          </div>
        </div>
...
<script>
import { uploadPaymentFile, uploadPaymentFileMore } from '../../../api/payment/index';
export default {
