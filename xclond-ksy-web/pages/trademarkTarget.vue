  ...
  <div>
    ...
    <div class="ly-page">
      <div class="box-head">
        ...
        <search-page @search="search" :select-show="true" placeholder="请输入商标名/申请号/受理号进行查询">
          <template #tips
      ...
      <div class="static-main">
        ...
        <div class="flex flex-c-c">
          <div @click="jumpByPath('/depot/register')" class="static-more flex flex-c-c">
            查看更多数据 <i class="icon-right"></i>
          </div>
        </div>
      </div>
      <!-- 美标律师排行榜 -->
      <!-- <div v-if="rank.length" class="rank-main">
        ...
        <div class="flex flex-c-c">
          <div @click="jumpByPath('/depot/lawyer')" class="static-more flex flex-c-c">
            查看更多排名数据<i class="icon-right"></i>
          </div>
        </div>
      </div> -->
      <!-- 行业知名品牌商标 -->
      <div class="brandes-main">
        ...
        <div @click="jumpByPath('/depot/brand')" class="btn flex flex-c-c">查看更多<i class="icon-right"></i></div>
      </div>
      <!-- 不能注册词库 -->
      <div class="disabled">
        <div class="disabled-main">
          ...
          <div class="flex flex-c-c">
            <div @click="jumpByPath('/depot/word')" class="static-more flex flex-c-c">
...
export default {
  ...
  methods: {
    ...
    async getStaticData() {
      ...
      try {
        let [{ data: applyList },  { data: trendList }, { data: timeData }, { data: applyPrescriptionTrendList}] = await Promise.all([
