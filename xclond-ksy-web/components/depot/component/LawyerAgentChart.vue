<template>
  <div class="lawyer-agent">
    <div class="title-header">
      <div class="title">律师代理商标数量</div>
      <div class="top"></div>
      <div class="num">{{ total }}</div>
      <div class="tag">总代理量:</div>
    </div>
    <div class="loading" v-if="agentLoading">
      <a-spin size="large" />
    </div>
    ...
    <div ref="agentChart" style="width: 100%; height: 259px" v-show="isShow"></div>
...
export default {
  ...
  watch: {
    topLawyerList(val) {
      ...
      <div style="font-size: 12px;font-family: Source Han Sans CN-Normal;font-weight: 400;color: rgba(0,0,0,0.65);">当前代理<span style="font-size: 16px;font-family: Source Han Sans CN-Bold;font-weight: bold;color: #397EF0;;margin:2px">${params.value}</span>人次</div>
    	`;
          },
          extraCssText:
      ...
      this.chart = this.$echarts.init(this.$refs.agentChart);
