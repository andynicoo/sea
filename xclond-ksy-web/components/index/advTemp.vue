<template>
  <div class="bottom-bg" :class="{ wgbg: NODE_PLA === 'wg' }">
...
.bottom-bg {
  height: 200px;
  background: url("@/assets/images/index/kby/bottom-bg-1.png") no-repeat center/cover;
  padding-top: 48px;
  h3 {
    color: #fff;
    font-size: 28px;
...
.wgbg {
  background: url("@/assets/images/wg/bottom-bg-1.png") no-repeat center/cover;
}
</style>
