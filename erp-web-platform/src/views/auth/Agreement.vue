<template>
  <div>
    <div
      class="title-div"
      style="margin:0.266667rem 0px 0px;padding:0px;font-family:sans-serif;"
    >
      <p
        class="title"
        style="color:#2B2B2B;font-size:0.533333rem;font-family:PingFangSC-Bold;text-align:center;"
      >
        马六甲ERP用户隐私协议
      </p>
    </div>
    <div
      class="policy"
      style="margin:0.0133333rem 0px 0px;padding:0px;background-color:#FFFFFF;font-family:sans-serif;"
    >
      <div class="text-div" style="margin:0px;padding:0.2rem 0.266667rem;">
        <p
          class="black-text"
          style='color:#333333;font-size:0.373333rem;vertical-align:middle;font-family:"'
        >
          马六甲ERP尊重和保护用户的隐私。本隐私政策将告诉您我们如何收集和使用有关您的信息，以及我们如何保护这些信息的安全。您成为马六甲ERP用户前务必仔细阅读本隐私条款并同意所有隐私条款。本隐私政策条款在您注册成为马六甲ERP用户后立即生效，并对您及马六甲ERP产生约束力。
        </p>
      </div>
      <div class="text-div" style="margin:0px;padding:0.2rem 0.266667rem;">
        <p
          class="sub-title"
          style="font-size:0.426667rem;vertical-align:middle;font-family:PingFangSC-Bold;"
        >
          一、我们可能收集的用户信息
        </p>
        <p
        ...
        <div
          class="sub-text-div"
          style="margin:0px 0px 0px 0.4rem;padding:0.133333rem 0.266667rem;background:#F5F5F5;"
        >
          <p
            class="sub-text"
            style='color:#202020;font-size:0.32rem;vertical-align:middle;font-family:"'
          >
            •
        ...
        >
          ...
          <p
            ...
            style='color:#202020;font-size:0.32rem;vertical-align:middle;font-family:"'
          >
            • 交易信息，指我们对您在马六甲ERP平台上形成的交易数据信息进行分析并形成用户信用数据库。
          </p>
        </div>
        <p
          class="black-text"
        ...
        >
          <p
            ...
            style='color:#202020;font-size:0.32rem;vertical-align:middle;font-family:"'
          >
            我们会通过第三方机构（包括但不限于通过合法的征信机构个人信用信息基础数据库及外部数据）查询您的信用报告中的身份、联系方式等个人身份、电信信息、地址、位置等基本
            信息和关联人信息以及个人贷款、各类信用卡和对外担保等信用及在商业活动中形成的各类交易记录，个人信贷交易信息及公共费用缴纳、违法违规信息及非银行类信息的其他信息，获取的您的肖像、工作情况、收入情况、家庭情况、社会关系情况、招聘应聘以及您在马六甲ERP的交易记录和使用信息等。
          </p>
        </div>
      </div>
      <div class="text-div" style="margin:0px;padding:0.2rem 0.266667rem;">
      ...
      <div class="text-div" style="margin:0px;padding:0.2rem 0.266667rem;">
        ...
        <p
          ...
          style='color:#333333;font-size:0.373333rem;vertical-align:middle;font-family:"'
        >
          2、其他注册用户就您在马六甲ERP活动中的违约行为发起诉讼程序时，我们将应该等注册用户的请求向该等注册用户披露您的用户信息；
        </p>
        <p
          class="black-text"
          style='color:#333333;font-size:0.373333rem;vertical-align:middle;font-family:"'
        ...
        <p
          ...
          style='color:#333333;font-size:0.373333rem;vertical-align:middle;font-family:"'
        >
          5、您通过马六甲ERP平台向第三方合作机构申请相关产品服务时，我们将根据您的授权向第三方提供您的用户信息；
        </p>
        <p
          class="black-text"
          style='color:#333333;font-size:0.373333rem;vertical-align:middle;font-family:"'
        ...
        >
          <p
            ...
            style='color:#202020;font-size:0.32rem;vertical-align:middle;font-family:"'
          >
            • 随着我们业务的持续发展，我们以及我们的关联公司有可能进行合并、收购、资产转让或类似的交易，您的个人信息有可能作为此类交易的一部分而被转移；<br />
      ...
      <div class="text-div" style="margin:0px;padding:0.2rem 0.266667rem;">
        ...
        <p
          ...
          style='color:#333333;font-size:0.373333rem;vertical-align:middle;font-family:"'
        >
          当用户需要注销本账号时，可联系 马六甲ERP 客服人员进行验证注销。
        </p>
      </div>
      <div class="text-div" style="margin:0px;padding:0.2rem 0.266667rem;">
        <p
