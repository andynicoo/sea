<template>
  <div>
    ...
    >
      ...
      <span slot="variationSku" slot-scope="text, record">
        <a class="me-link">{{ record.variationSku }}</a>
      </span>
    ...
    <a-modal
      ...
      width="500px"
    >
      <ImportExcel :multiple="false" ref="importExcel" />
    </a-modal>
...
export default {
  ...
  methods: {
    getTableData() {
      ...
      return Storage.getProductGoods({
        size,
        current,
        ...params,
        keyword: undefined,
