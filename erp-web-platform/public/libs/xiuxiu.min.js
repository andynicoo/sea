...
xiuxiu.embedSWFlightEditor = xiuxiu.lightEditor || {
  url:
    xiuxiu.protocol +
    '//open.web.meitu.com/sources/light/PhotoEditor.swf?version=201410201425',
...
xiuxiu.lightPuzzle = xiuxiu.lightPuzzle || {
  url:
    xiuxiu.protocol +
    '//open.web.meitu.com/sources/puzzle/CollagePlugin.swf?version=201305211645',
...
xiuxiu.daitoutie = xiuxiu.daitoutie || {
  url:
    xiuxiu.protocol +
    '//open.web.meitu.com/sources/daitoutie/FacePhoto.swf?version=201304251419',
...
xiuxiu.avatarEditor = xiuxiu.avatarEditor || {
  url:
    xiuxiu.protocol +
    '//open.web.meitu.com/sources/avatar/avatar.swf?version=201410201414',
...
xiuxiu.batchEditor = xiuxiu.batchEditor || {
  url:
    xiuxiu.protocol +
    '//xiuxiu.web.meitu.com/plugin/batch/plugin.swf?version=201405281142',
...
xiuxiu.embedSWF = function(b, c, f, m, e) {
  ...
  if (document.getElementById(xiuxiu.container)) {
    document.getElementById(xiuxiu.container).innerHTML =
      '<p><a href="' +
      xiuxiu.protocol +
      '//www.adobe.com/go/getflashplayer"><img alt="Get Adobe Flash player" src="' +
      xiuxiu.protocol +
  ...
  swfobject.embedSWF(
    ...
    m,
    g,
    xiuxiu.protocol + '//open.web.meitu.com/sources/expressInstall.swf',
    h,
    l,
    xiuxiu.attributes
  )
