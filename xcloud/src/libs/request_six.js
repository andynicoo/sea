...
let baseUrl = 'https://calutax.itaxs.com';
...
service.interceptors.request.use((config) => {
  ...
  let arrayQueryRequestList = ['/workorder/management/workFunctionCategory/saveOrUpdate', '/workorder/management/workFunctionWorkflowRelation/saveOrUpdate', '/workorder/management/tax/reg/transform_out'];
