<template>
  <el-dialog title="更改税务经理" :visible.sync="dialogvisible" width="460px" center @close="reset">
    <el-form :model="form" :rules="rules" ref="form">
      <el-form-item prop="disposeId">
        <el-select style="width: 410px" v-model="form.disposeId" size="small" filterable>
...
<script>
import { changeDispose } from '@/api/newApi/workOrder/taxInspection';
