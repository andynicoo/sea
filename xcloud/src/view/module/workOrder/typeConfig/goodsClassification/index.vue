  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table border :data="list" v-loading="tableLoading" element-loading-spinner="icon loading" element-loading-text="拼命加载中" :height="tableHeight">
        ...
        <el-table-column align="center" min-width="150" label="商品分类" show-overflow-tooltip prop="productCategoryName"></el-table-column>
        ...
        <el-table-column align="center" width="150" label="操作" fixed="right">
          <template slot-scope="scope">
            <el-tooltip content="详情" placement="top">
              <el-link type="primary" :underline="false" @click="detail(scope.row, 'detail')" v-show="hasAuthority('O2_1')">
                <i class="icon icon-see"></i>
              </el-link>
            </el-tooltip>
            <el-tooltip content="编辑" placement="top">
              <el-link type="primary" :underline="false" @click="detail(scope.row, 'edit')" v-show="hasAuthority('O2_2')">
...
<script>
import { getWorkFunctionList, workCategory, workType } from '@/api/newApi/workOrder/typeConfig';
