        ...
        <div class="itemList">
          <div class="item">
            <div class="item-title">
              新增用户数
              <Tooltip content="在统计周期内，新增的注册用户数"
                       placement="bottom">
          ...
          <div class="item">
            <div class="item-title">
              成交用户数
              <Tooltip content="在统计周期内，付款成功的用户数"
          ...
          <div class="item">
            <div class="item-title">
              客单价
              <Tooltip content="在统计周期内，支付总金额/成交用户数=客单价"
                       placement="bottom-end">
                <img src="@/assets/images/home/info-circle.png"
                     alt="">
              </Tooltip>
          ...
          <div class="item">
            <div class="item-title">
              总退款金额
              <Tooltip content="在统计周期内，所有退款订单的总额"
                       placement="bottom-end">
                <img src="@/assets/images/home/info-circle.png"
                     alt="">
              </Tooltip>
          ...
          <div class="item">
            <div class="item-title">
              支付订单数
              <Tooltip content="在统计周期内，已付款的订单数+退款的订单数=支付订单数"
                       placement="bottom-end">
                <img src="@/assets/images/home/info-circle.png"
                     alt="">
              </Tooltip>
          ...
          <div class="item">
            <div class="item-title">
              支付总金额
              <Tooltip content="在统计周期内，已付款的订单金额+退款的订单金额=支付总金额"
                       placement="bottom-end">
                <img src="@/assets/images/home/info-circle.png"
                     alt="">
              </Tooltip>
          ...
          <div class="item">
            <div class="item-title"
                 style="color:#16ADE9;">
              复购率
              <Tooltip content="统计周期内重复购买的客户数/统计周期内的总客户数=复购率"
                       placement="bottom-end">
                <img src="@/assets/images/home/info-circle.png"
                     alt="">
              </Tooltip>
            ...
            <div class="item-content">
              {{progressData.twoPurchaseRate || 0}}%
            </div>
          </div>
        </div>
      </Row>
                  ...
                  <div class="box"
                    ...
                    <p class="top">
                      <img src="@/assets/images/home/icon2.png"
                           alt="">
                      <span class="word">新增用户数</span>
                      <span class="num">{{businessAnalysisData.registerUserCount || 0}}</span>
                    </p>
                    <p class="bottom">
                      今日新增用户数 {{businessAnalysisData.registerUserDayCount || 0}}
                    </p>
                  </div>
                  <div class="box"
                  ...
                  <div class="box"
                    ...
                    <p class="top">
                      <img src="@/assets/images/home/icon4.png"
                           alt="">
                      <span class="word">支付订单数</span>
                      <span class="num">{{businessAnalysisData.payOrderCount || 0}}</span>
                    </p>
                    <p class="bottom">
                      今日支付订单数 {{businessAnalysisData.payOrderDayCount || 0}}
                    </p>
                  </div>
                  <!-- <div class="box"
                  ...
                  <div class="box"
                    ...
                    <p class="top">
                      <img src="@/assets/images/home/icon6.png"
                           alt="">
                      <span class="word">支付总金额</span>
                      <span class="num">{{businessAnalysisData.payAmount || 0}}</span>
                    </p>
                    <p class="bottom">
                      今日支付金额 {{businessAnalysisData.payDayAmount || 0}}
                    </p>
                  </div>
                </div>
              </div>
