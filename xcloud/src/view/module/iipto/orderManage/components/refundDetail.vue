  ...
  <div class="orderDetail">
    ...
    <div class="orderDetailInfo">
      <div class="titleBox">
        ...
        <Button v-if="refundDetailInfo.status === 0"
                v-show="hasAuthority('order_refund02')"
                type="primary"
                @click="auditFun(id)">审核</Button>
        <Button v-if="refundDetailInfo.status === 1"
                v-show="hasAuthority('order_refund03')"
                type="primary"
                @click="refundFun()">确认退款</Button>
      </div>
      <div class="basicInfoBox">
        ...
        <Row class="rowItem">
          <Col span="4">退款凭证：</Col>
          <Col span="4">
          <a :href="rowInfo.refundCertificate"
             target="_blank"
             v-if="rowInfo.refundCertificate">点击查看</a>
          </Col>
        </Row>
        <Row class="rowItem">
    ...
    <div class="orderDetailInfo">
      ...
      <div class="basicInfoBox">
        ...
        <Row class="rowItem">
          ...
          <Col span="4">订单来源:</Col>
          <Col span="4">{{orderDetailInfo.orderBusinessSource==1?'必胜道':orderDetailInfo.orderBusinessSource==2?'卖家成长':orderDetailInfo.orderBusinessSource==3?'跨标云':''}}</Col>
    ...
    <auditMedal v-if="isAuditMedalShow"
                ...
                :refundId="rowInfo.id"
                @refresh="refreshDetail"></auditMedal>
    <refundMedal v-if="isRefundMedalShow"
                 @changeState="auditMedalFun"
                 :refundInfo="rowInfo"
                 @refresh="refreshDetail"></refundMedal>
  </div>
</template>
<script>
