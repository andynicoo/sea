  ...
  <div>
    ...
    <Form :model="formInfo" label-position="top" :rules="ruleValidate" ref="formInfo">
      ...
      <div class="step2-box" v-if="steps==2">
        ...
        <FormItem :label="formInfo.applyType==1?'营业执照上的详细地址（英文）':'身份证上的详细地址（英文）'" prop="applyAddresEn" class="width100">
          <Input v-model="formInfo.applyAddresEn" style="width:398px;" :disabled="isEditor" :maxlength="100" placeholder="示例：Room 302, Bldg. 4"></Input>
