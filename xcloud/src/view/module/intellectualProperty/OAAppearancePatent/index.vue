  ...
  <div class="app-container">
    ...
    <div class="table-container">
      ...
      <el-table border :data="list" v-loading="tableLoading" element-loading-spinner="icon loading" element-loading-text="拼命加载中" :height="tableHeight">
        ...
        <el-table-column align="center" min-width="200px" label="服务生成日期" sortable show-overflow-tooltip prop="createTime"></el-table-column>
        <el-table-column align="center" min-width="70" label="操作" fixed="right">
          <template slot-scope="scope">
            <el-tooltip content="查看" placement="top">
              <el-link type="primary" :underline="false" @click="detail(scope.row)" v-show="hasAuthority('M2_12')">
...
import { OAPatentList } from '@/api/newApi/intellectualProperty/OAAppearancePatent';
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      OAPatentList(this.$util.objTrim(formData))
        .then((res) => {
