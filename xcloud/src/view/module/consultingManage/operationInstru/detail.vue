  ...
  <div class="app-container">
    <div class="header-container">
      ...
      <div class="consulting-info">
        ...
        <div class="info"><i class="el-icon-user" style="margin-right: 4px"></i>{{form.createName}}</div>
      </div>
...
<script>
import {getOperationDocumentAllInfo} from '@/api/newApi/consultingCenter/operationInstru'
...
export default {
  ...
  methods: {
    getInfo() {
      getOperationDocumentAllInfo(this.id).then(res => {
