<template>
  <div class="modalCount"
          ...
          <div class="topLeft">
            ...
            <FormItem label="亚马逊销售额文件:"
              ...
              <Upload :action="fileUpload"
                      ...
                      :on-remove="(file,fileList)=>{handleAmzRemoveFile (file,fileList,row)}"
    ...
    <div class="btBox">
      ...
      <Button v-if="status==21"
              @click="submitDeclare">提交申报</Button>
...
<script>
import { submitDeclare } from '@/api/taxService/workOrder.js'
