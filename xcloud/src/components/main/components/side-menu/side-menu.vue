    ...
    <div class="menu-collapsed" v-show="collapsed" :list="menuList">
      <template v-for="item in menuList">
        ...
        <Tooltip
          ...
          :key="`drop-menu-${item.name}`"
        >
          <a @click="handleSelect(getNameOrHref(item, true))" class="drop-menu-a drop-menu-side" :style="{ textAlign: 'center' }">
            <common-icon
              v-if="item.icon.indexOf('side') < 0"
              :size="rootIconSize"
              :color="textColor"
