<template>
  <EchartView
    title="商品分类统计"
    tips="统计服务截止时间T天内各类产品续费情况占比；点击对应分类可查询下级分类"
  ...
  <MoreView
    ...
    :params="params"
    :methodName="getProductCategoryStatistics"
    :otherParams="{
...
import { getProductCategoryStatistics } from '@/api/dataCenter/renewalStatistics';
